...
import InformationUpdate from "./Updates/InformationUpdate/InformationUpdate";
import InternshipDetailsUpdate from "./Updates/IntershipDetailsUpdate/InternshipDetailsUpdate";
import ProjectDetailsUpdate from "./Updates/ProjectDetailsUpdate/ProjectDetailsUpdate";
import SkillsUpdate from "./Updates/SkillsUpdate/SkillsUpdate";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/Skillsupdate" element={<SkillsUpdate/>} />   
        <Route path="/Experienceupdate" element={<WorkExperienceUpdate/>} />   
        <Route path="/Internshipupdate" element={<InternshipDetailsUpdate/>} />   
